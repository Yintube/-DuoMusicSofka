...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(SongList[19].getIdentifier() + "." +SongList[19].getTitle() + " " + SongList[19].getDuration() +" Seg.");
        System.out.println(SongList[19].getDescription());
        System.out.println("Año: " + SongList[19].getYear());
        System.out.println("Genero: " + SongList[19].getGenre());
        System.out.println("Caratula: " + SongList[19].getCoverPage());
    }
}
